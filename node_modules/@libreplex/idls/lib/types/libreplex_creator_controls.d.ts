export type LibreplexCreatorControls = {
        ...
        },
        {
            ...
            "type": {
                ...
                "fields": [
                    ...
                    {
                        "name": "remainingAccountMetas";
                        "type": {
                            "vec": {
                                "defined": "CustomProgramAccountMeta";
                            };
                        };
                    }
                ];
                ...
                "fields": [
                    {
                        "name": "key";
                        "type": {
                            "defined": "CustomProgramAcountMetaKey";
                        };
                    },
                    {
                        "name": "isSigner";
        ...
        },
        {
            ...
            "type": {
                ...
                "variants": [
                    ...
                    {
                        "name": "ReceiverPlaceHolder";
                    },
                    {
                        "name": "PayerPlaceHolder";
                    }
                ];
            };
        },
        {
            "name": "CustomProgramAcountMetaKey";
            "type": {
                "kind": "enum";
                "variants": [
                    {
                    ...
                    {
                        "name": "DerivedFromSeeds";
                        "fields": [
                            {
                                "defined": "KeySeedDerivation";
                            }
                        ];
                    }
                ];
    ...
    "errors": [
        ...
        {
            "code": 6010;
            "name": "InvalidRemainingAccountsForCustomProgramControl";
...
export declare const IDL: LibreplexCreatorControls;
