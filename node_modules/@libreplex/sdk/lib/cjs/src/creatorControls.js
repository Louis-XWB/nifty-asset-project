...
exports.controlToAnchor = exports.anchorToControl = void 0;
function anchorToControl(c) {
    if (c.allowList) {
        return {
            name: "AllowList",
...
exports.anchorToControl = anchorToControl;
function controlToAnchor(c) {
    switch (c.name) {
        case "SolPayment":
            return {
                payment: {
        ...
        case "CustomProgram":
            ...
            return {
                customProgram: {
                    0: Object.assign(Object.assign({}, c), { remainingAccountMetas })
                }
            };
...
exports.controlToAnchor = controlToAnchor;
